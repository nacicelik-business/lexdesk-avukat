        ...
        <div style={{display:"flex",alignItems:"center",gap:8,flexShrink:0,marginRight:8}}>
          ...
          <div style={{display:"flex",flexDirection:"column",lineHeight:1.25}}>
            {(()=>{
              ...
              if(hukukIdx > 0) {
                return <>
                  <span style={{color:"#e2c97e",fontFamily:"'Playfair Display',serif",fontWeight:700,fontSize:13,whiteSpace:"nowrap"}}>{wn.slice(0,hukukIdx).trim()}</span>
                  <span style={{color:"#6b7280",fontSize:10,whiteSpace:"nowrap"}}>{wn.slice(hukukIdx).trim()}</span>
                </>;
              }
              return <span style={{color:"#e2c97e",fontFamily:"'Playfair Display',serif",fontWeight:700,fontSize:13,whiteSpace:"nowrap"}}>{wn}</span>;
            })()}
          </div>
        </div>
